...
def main():
    ...
    gen_config = "_config_files/generation/conditional/xrd_studies/ablation/mp-xrd-scratch-20shot_eval.jsonc"
    gen_parquet = "_artifacts/mp-20-pxrd/ablation/mp-20-scratch-20shot_gen.parquet"
    post_parquet = "_artifacts/mp-20-pxrd/ablation/mp-20-scratch-20shot_post.parquet"
    ref_parquet = "_artifacts/mp-20-pxrd/mp-test_ref.parquet"
    metrics_parquet = "_artifacts/mp-20-pxrd/ablation/mp-20-scratch-20shot_metrics.parquet"
    metrics_1gen_parquet = "_artifacts/mp-20-pxrd/ablation/mp-20-scratch-1shot_metrics.parquet"
