...
def main():
    ...
    train_config = "_config_files/training/unconditional/mp-20-pxrd-slider-scratch-uncond.jsonc"
    gen_config = "_config_files/generation/conditional/xrd_studies/ablation/mp-xrd-scratch-uncond-20shot_eval.jsonc"
    gen_parquet = "_artifacts/mp-20-pxrd/ablation/mp-20-scratch-uncond-20shot_gen.parquet"
    post_parquet = "_artifacts/mp-20-pxrd/ablation/mp-20-scratch-uncond-20shot_post.parquet"
    ref_parquet = "_artifacts/mp-20-pxrd/mp-test_ref.parquet"
    metrics_parquet = "_artifacts/mp-20-pxrd/ablation/mp-20-scratch-uncond-20shot_metrics.parquet"
    metrics_1gen_parquet = "_artifacts/mp-20-pxrd/ablation/mp-20-scratch-uncond-1shot_metrics.parquet"
    ...
    try:
        ...
        print("\nTraining model...")
        run_command_with_logging(cmd_train, "train_model", timestamp)
    except subprocess.CalledProcessError as e:
        print(f"Error during model training: {e}")
        return

    # wait 1 minute to ensure model saving is complete
    import time
    time.sleep(60)
